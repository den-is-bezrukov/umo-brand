...
export default function Umo8MaxPdf({ fullPrice, creditPrice, qrUrl }: Props) {
  return (
    <Document>
      <Page size="A3" style={{ padding: 0, backgroundColor: 'white' }}>
        ...
        <View style={{ position: 'absolute', left: px(100), top: px(835), width: px(1554), gap: px(30) }}>
          ...
          <Text style={{ fontFamily: 'Geist', fontWeight: 500, fontSize: px(54), lineHeight: 1.38, color: 'black' }}>
            {'Комфорт продуман до мелочей: массаж,\nпанорамная крыша и вентиляция всех сидений.\n'}
            {'Сиденья с режимом нулевой гравитации —\nдорога больше не утомляет.\n'}
            {'Удаленное управление автомобилем из любой точки\nчерез мобильное приложение.'}
          </Text>
        </View>
