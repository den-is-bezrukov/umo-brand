import svgPaths from '@/imports/Umo8MaxPriceCard/svg-nhd8qcz7hx'
import imgCar from '@/imports/Umo8MaxPriceCard/8f2366272706e62fb3ae0e7197b2103311e7e454.png'
...
export default function Umo8MaxCard({ fullPrice, creditPrice, qrSvg }: Props) {
  return (
    <div className="bg-white relative" style={{ width: 1754, height: 2480 }}>
      ...
      <div className="[word-break:break-word] absolute content-stretch flex flex-col font-['Geist',sans-serif] font-medium gap-[30px] items-start left-[100px] text-black top-[835px] w-[1554px]">
        <p className="leading-[1.25] opacity-60 relative shrink-0 text-[36px] w-full">Это комплектация Макс:</p>
        <div className="leading-[0] relative shrink-0 text-[54px] w-full">
          <p className="leading-[1.38] mb-0">Комфорт продуман до мелочей: массаж, панорамная крыша и вентиляция всех сидений.</p>
          <p className="leading-[1.38] mb-0">Сиденья с режимом нулевой гравитации — дорога больше не утомляет.</p>
          <p className="leading-[1.38]">Удаленное управление автомобилем из любой точки через мобильное приложение.</p>
        </div>
      </div>
      ...
      {/* Disclaimer */}
      <div className="[word-break:break-word] absolute bottom-[60px] flex flex-col font-['Geist',sans-serif] font-normal justify-end leading-[0] left-[100px] text-[18px] text-white whitespace-nowrap">
