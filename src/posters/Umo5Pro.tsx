import svgPaths from "@/imports/Umo5ProPriceholder/svg-wj2spj0pdy";
import imgRectangle1 from "@/imports/Umo5ProPriceholder/b48708a1e3b75c3f3b0d783da942f3530b36498c.png";
import imgImage4 from "@/imports/Umo5ProPriceholder/4463e47a6056ff4d3f0870fe15d8aed7a43ea000.png";
...
export default function Umo5Pro({ fullPrice, creditPrice, qrSvg }: Props) {
  return (
    <div className="bg-white relative" style={{ width: 2970, height: 4200 }}>
      ...
      {/* Main content block: headline + description + prices */}
      <div className="absolute content-stretch flex flex-col gap-[110px] items-start left-[165px] top-[484px] w-[2655px]">
        {/* Headline + description group */}
        <div className="content-stretch flex flex-col gap-[120px] items-start relative shrink-0 w-[2423px]">
          <p className="[word-break:break-word] font-['Geist',sans-serif] font-medium leading-[1.15] relative shrink-0 text-[160px] text-black w-[2423px] whitespace-pre-wrap">
          ...
          <div className="[word-break:break-word] content-stretch flex flex-col font-['Geist',sans-serif] font-medium gap-[38px] items-start relative shrink-0 text-black w-full">
            <p className="leading-[normal] opacity-60 relative shrink-0 text-[60px] w-full">Это комплектация Pro:</p>
            <p className="leading-[1.2] relative shrink-0 text-[100px] w-full">Всё нужное для комфортной городской жизни: электрический привод багажника с дистанционным управлением. За рулём помогает Алиса — голосом откроет багажник, включит любимую песню, найдёт дорогу. Управляйте автомобилем из любой точки через приложение UMO.</p>
          </div>
          {/* Alisa icon */}
          <div className="absolute h-[128px] left-[2031px] top-[212px] w-[133px]">
        ...
        {/* Prices */}
        <div className="[word-break:break-word] content-stretch flex flex-col gap-[70px] items-start relative shrink-0 text-black w-[751px]">
      ...
      {/* Car image / QR code */}
      <div className="absolute h-[488.565px] left-[2303px] top-[2697px] w-[517px]">
        {qrSvg
