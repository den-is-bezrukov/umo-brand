import svgPaths from "@/imports/Umo8UltraPriceholder/svg-f3dgflg9ox";
import imgRectangle1 from "@/imports/Umo8UltraPriceholder/05278b6b40a2933dab666c657dae0135ba82c32c.png";
import imgImage5 from "@/imports/Umo8UltraPriceholder/4463e47a6056ff4d3f0870fe15d8aed7a43ea000.png";
...
function Headline() {
  return (
    <div className="h-[968px] relative shrink-0 w-[2423px]">
      <div className="[word-break:break-word] absolute font-['Geist',sans-serif] font-medium h-[968px] leading-[0] left-0 text-[160px] text-black top-0 w-[2440px] whitespace-pre-wrap">
...
function Description() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Geist',sans-serif] font-medium gap-[38px] items-start relative shrink-0 text-black w-full">
      <p className="leading-[normal] opacity-60 relative shrink-0 text-[60px] w-full">Это комплектация ULTRA:</p>
      <p className="leading-[1.2] relative shrink-0 text-[100px] w-full whitespace-pre-wrap">
        {`Комфорт продуман до мелочей: массаж, панорамная крыша и вентиляция всех сидений. Сиденья `}
        <br aria-hidden />
        {`с режимом нулевой гравитации — дорога больше `}
        <br aria-hidden />
        {`не утомляет. Проекция на лобовом стекле, салон `}
        <br aria-hidden />
        в коже Nappa с замшевым потолком, объёмный звук 22 динамиков. Машина сама умеет парковаться, а ИИ фары элегантно подчеркивают статус автомобиля
      </p>
    </div>
  );
}

export default function Umo8Ultra({ fullPrice, creditPrice, qrSvg }: Props) {
  return (
    <div className="bg-white relative" style={{ width: 2970, height: 4200 }}>
      ...
      {/* Prices */}
      <div className="[word-break:break-word] absolute content-stretch flex flex-col gap-[70px] items-start left-[165px] text-black top-[2608px] w-[751px]">
      ...
      {/* Car image / QR code */}
      <div className="absolute h-[489px] left-[2303px] top-[2715px] w-[517px]">
        {qrSvg
